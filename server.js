  ...
  app.post('/api/query', async (req, res) => {
    ...
    try {
      ...
      const systemPrompt =
        ...
        'At the end of each response, anticipate what the user might want to ask next. Generate 2 to 3 short follow-up options based only on the original query and your reply. Format them like this, on a new line: SUGGESTED: [Retail Banking] | [Commercial Lending] | [Digital Channels]  Each suggestion must be:  - 1 to 4 words long  - Directly related to the user\'s intent  - Avoid repeating the main response  - Not generic (e.g., avoid [Sure], [OK], [Learn More])'
        ;
